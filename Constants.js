...
const BUNDLE_SERVICES = {
    TWO: [
        SERVICES.SHRIEKWING,
        SERVICES.HUNTSMAN_ALTIMOR
    ],
    THREE: [
        SERVICES.SHRIEKWING,
        SERVICES.HUNTSMAN_ALTIMOR,
        SERVICES.HUNGERING_DESTROYER
    ],
    FOUR: [
        SERVICES.SHRIEKWING,
        SERVICES.HUNTSMAN_ALTIMOR,
        SERVICES.HUNGERING_DESTROYER,
        SERVICES.SUN_KINGS_SALVATION
    ],
    FIVE: [
        SERVICES.SHRIEKWING,
        SERVICES.HUNTSMAN_ALTIMOR,
    ...
    NINE: [
        ...
        SERVICES.THE_COUNCIL_OF_BLOOD,
        SERVICES.SLUDGEFIST,
        SERVICES.STONE_LEGION_GENERALS
    ]
}
